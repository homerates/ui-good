...
// neighborhoods. See README Compliance Notes.
...
/**
 * Swappable abstraction — MockLocationDataSource (lib/locationDataSource.ts) implements this
 * today with static numbers. A real implementation plugs in here without any component change:
