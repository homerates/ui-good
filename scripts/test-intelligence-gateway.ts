...
async function runResponseCoverageAndContractTests(
  ...
  // Currently property-intelligence-v1.6 (2026-09-10) -- a deliberate,
  ...
  record('O', 'contract_version is the current deliberate version', 'property-intelligence-v1.6', rNa.ok ? rNa.data.contract_version : 'n/a', rNa.ok && rNa.data.contract_version === 'property-intelligence-v1.6' ? 'PASS' : 'FAIL', '');
