...
async function main() {
  ...
  if (sb) {
    ...
    if (id) {
      ...
      record('11b. property-intelligence-v1.7 external contract unchanged, still validates',
        parsedProp.success && shapedProp.contract_version === 'property-intelligence-v1.7' ? 'PASS' : 'FAIL', parsedProp.success ? 'valid' : 'invalid');
    }
  }
