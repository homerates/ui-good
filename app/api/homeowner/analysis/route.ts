...
import {
  historicalRate, fhfaRate, stateFromAddress, remainingBalance, monthlyPayment, monthsAgo,
...
// Historical rates, FHFA state appreciation, and amortization helpers now
// live in lib/homeownerCalc.ts — shared with my-home's buyer/preview path
...
// Bounded via isPlausibleSaleYear — a sale can never be in the future. Without an upper
