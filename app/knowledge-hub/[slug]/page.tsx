...
export async function generateMetadata({
  ...
  return {
    ...
    twitter: { card: 'summary_large_image', title: article.title, description: article.excerpt, images: ['https://chat.homerates.ai/assets/share/og/homerates-brand-default-og-1200x630-v1.png'] },
  };
}
