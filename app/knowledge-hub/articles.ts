...
**Bottom line:** The process is linear but document-heavy. Your job is to stay responsive, avoid major financial changes (no new credit, no large deposits without documentation), and read every disclosure you receive.
  ...
  {
    slug: 'why-mortgage-rates-arent-the-whole-story',
    title: "Why Mortgage Rates Aren't the Whole Story",
    excerpt: 'The rate headline grabs attention — but your actual monthly payment depends on factors most buyers overlook until it\'s too late.',
...
| Scenario | Rate | P&I | Taxes | Insurance | PMI | Total PITI |
|---|---|---|---|---|---|---|
| $400k / 20% down | 6.5% | $2,023 | $417 | $130 | $0 | **$2,570** |
| $400k / 5% down | 6.5% | $2,402 | $417 | $130 | $213 | **$3,162** |
...
**Bottom line:** When comparing mortgage options, always look at PITI — not just the rate. A lower rate with higher fees or a smaller down payment can cost you more than a slightly higher rate with less friction.
  ...
  {
    slug: 'conventional-loans-explained',
    title: 'Conventional Loans Explained',
    excerpt: 'The most common mortgage product — how it works, who qualifies, and when it makes more sense than FHA.',
    category: 'Loan Types',
    readTime: '5 min read',
    date: 'February 2026',
    body: `
...
**Bottom line:** Conventional is the workhorse of the mortgage market. If your credit and down payment are solid, it's usually the right call — especially since PMI isn't permanent.
  ...
  },
  {
    ...
    excerpt: 'The go-to loan for first-time buyers — low down payment, flexible credit, and what the lifetime MIP actually costs you.',
    category: 'Loan Types',
    readTime: '5 min read',
    date: 'February 2026',
    body: `
...
- **High-cost areas (e.g., most of California):** Up to $1,209,750
- **National floor:** $524,225
...
### FHA vs. Conventional Decision Framework
...
**Bottom line:** FHA is a powerful first step into homeownership for buyers who need flexibility on credit or down payment. The trade-off is lifetime MIP — which is manageable but not free. Plan for the exit.
  ...
  },
  {
    ...
    title: 'VA Loans: The $0 Down Benefit Explained',
    excerpt: "The most underused benefit in the military community — no down payment, no PMI, and more flexible qualification than most buyers realize.",
    category: 'Loan Types',
    readTime: '5 min read',
    date: 'January 2026',
    body: `
...
| Credit score minimum | No VA minimum; lenders typically require 580–620 |
| DTI | Up to 41% standard; flexible with residual income |
| Owner-occupied | Yes |
...
**Bottom line:** If you or your spouse served, explore VA before anything else. The combination of no down payment and no PMI is nearly impossible to match with any other product.
  ...
  },
  {
    ...
    title: 'Jumbo Loans Explained',
    excerpt: 'When your purchase price exceeds conforming limits, you enter jumbo territory — with stricter requirements and different rate dynamics.',
    category: 'Loan Types',
    readTime: '5 min read',
    date: 'January 2026',
    body: `
...
- 20% down → $720,000 loan = conforming
- 10% down → $810,000 loan = jumbo
...
- Loan: $1,200,000
- Monthly PITI: ~$8,500
- 12-month reserve: ~$102,000

That's in addition to the down payment.

---

### Jumbo vs. Two Conforming Loans (Piggyback)
...
- First mortgage: $806,500 (conforming)
- Second mortgage: $93,500 (HELOC or fixed second)
...
**Bottom line:** Jumbo loans are achievable with the right profile — strong credit, solid reserves, and full documentation. The key decision point is whether to increase your down payment to stay in conforming territory.
  ...
  },
  {
    ...
    excerpt: 'Qualify on rental income, not your W-2 — the go-to loan for real estate investors who\'ve grown beyond what traditional lending allows.',
    category: 'Loan Types',
    readTime: '5 min read',
    date: 'December 2025',
    body: `
...
| DSCR minimum | 1.0–1.25 (lender dependent) |
| Loan limits | Up to $3M+ (non-QM product) |
| Property types | SFR, 2–4 units, condos, short-term rentals |
| Rate | 0.5–1.5% above conventional (non-QM premium) |
...
|---|---|---|
| Income qualification | Personal DTI | Property DSCR |
| Max financed properties | 10 (Fannie/Freddie) | Unlimited |
| Rate | Lower | 0.5–1.5% higher |
| Documentation | Full income docs | Minimal personal income docs |
| Best for | W-2 buyers early in portfolio | Scaling investors |
...
**Bottom line:** DSCR is the workhorse loan for serious real estate investors. The rate premium is real, but the ability to qualify on the property rather than your personal income unlocks scale that traditional lending can't.
  ...
  },
  {
    ...
    title: 'Down Payment Assistance: Zero DPA and How It Works',
    excerpt: 'Many buyers assume they need 20% down. Several programs offer 3.5% or even zero down — here\'s how they actually work.',
    category: 'Programs',
    readTime: '4 min read',
    date: '2025',
    body: `
...
**Bottom line:** DPA programs are real, accessible, and widely underused. If cash is your barrier, talk to a lender who specializes in DPA programs — particularly HFA-approved lenders in your state.
  ...
  {
    slug: 'arm-loans-explained',
    title: 'ARM Loans Explained: When Adjustable Rates Make Sense',
    excerpt: "Adjustable-rate mortgages get a bad reputation — but in the right scenario, they're a legitimate tool for saving money.",
    category: 'Loan Types',
    readTime: '4 min read',
    date: '2025',
    body: `
