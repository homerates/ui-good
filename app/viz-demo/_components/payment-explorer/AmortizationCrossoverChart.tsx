...
import type { AmortizationPeriod } from '../../_lib/amortization';
import { colors, motion as motionTokens } from '../../_design-system';
import { formatCurrency, formatMonthYear } from '../../_lib/formatters';
    ...
    <div>
      ...
      {crossoverMonth && (
        <p style={{ marginTop: 12, fontSize: 14, color: '#475569', lineHeight: 1.6 }}>
          <span style={{ fontWeight: 600, color: '#0f172a' }}>{formatMonthYear(crossoverMonth)}</span> is
