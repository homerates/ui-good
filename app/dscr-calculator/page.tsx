    ...
    return (
        <>
                            ...
                            <tbody>
                                {dscrThresholds.map((row, i) => (
                                    <tr key={i}>
                                        ...
                                        <td>{row.ltv}</td>
                                        <td>{row.rate}</td>
                                        <td style={{ fontSize: '0.82rem', color: 'var(--muted, #6b7280)' }}>{row.notes}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
            ...
            <style>{`
                ...
                .dscr-page .breadcrumb li[aria-current] { color: var(--fg, #111827); font-weight: 500; }
                ...
                .dscr-page .embed-header p { margin: 0 0 1.25rem; color: var(--muted, #6b7280); font-size: 0.95rem; }
                .dscr-page .seed-chips {
                    display: flex; flex-wrap: wrap; gap: 8px;
                    align-items: center; margin-bottom: 1rem;
                }
                .dscr-page .seed-label { font-size: 13px; color: var(--muted, #6b7280); }
                .dscr-page .seed-chip {
                ...
                .dscr-page .seed-chip:hover { border-color: rgba(0,0,0,0.3); }
                .dscr-page .cta-block {
                ...
                .dscr-page .cta-sub a { color: var(--accent, #22c55e); }
                ...
                .dscr-page .feature-card p { font-size: 0.88rem; color: var(--muted2, #374151); margin: 0; line-height: 1.55; }
                ...
                .dscr-page .example-table td { padding: 10px 12px; border-bottom: 1px solid rgba(0,0,0,0.06); }
                .dscr-page .example-table tr:last-child td { border-bottom: none; }
                .dscr-page .income-cell { font-weight: 600; }
                .dscr-page .price-cell { font-weight: 500; color: var(--accent2, #059669); }
                .dscr-page .negative-cell { font-weight: 500; color: #dc2626; }
                .dscr-page .table-note { font-size: 0.8rem; color: var(--muted, #6b7280); margin: 0; line-height: 1.5; }
                .dscr-page .table-note a { color: var(--accent, #22c55e); }

                /* How it works */
                .dscr-page .how-it-works { margin-bottom: 3rem; }
                .dscr-page .steps-list { padding-left: 1.25rem; margin: 0; }
                .dscr-page .steps-list li { margin-bottom: 0.9rem; font-size: 0.95rem; line-height: 1.6; color: var(--muted2, #374151); }
                .dscr-page .steps-list strong { color: var(--fg, #111827); }
                ...
                .dscr-page .author-cred { font-size: 0.82rem; color: var(--muted, #6b7280); margin-bottom: 0.4rem; }
                .dscr-page .author-bio { font-size: 0.88rem; color: var(--muted2, #374151); margin: 0; line-height: 1.55; }
                .dscr-page .last-updated { font-size: 0.8rem; color: var(--muted, #6b7280); margin: 0 0 0.5rem; }
                .dscr-page .disclaimer { font-size: 0.8rem; color: var(--muted, #6b7280); margin: 0; line-height: 1.55; }
                ...
                .dscr-page .faq-question::after { content: '+'; font-size: 1.2rem; color: var(--muted, #6b7280); }
                ...
                .dscr-page .related-desc { font-size: 0.83rem; color: var(--muted, #6b7280); line-height: 1.5; }
