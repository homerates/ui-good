// app/how-much-house-can-i-afford-on-100k-salary/page.tsx
import type { Metadata } from 'next';
import Link from 'next/link';

export const metadata: Metadata = {
    title: 'How Much House Can I Afford on a $100k Salary? | HomeRates.ai',
    description:
        'On a $100,000 salary you can typically afford a home between $384,000–$560,000 depending on down payment and debts. Three real scenarios with monthly payment breakdown. 2026 rates.',
    keywords: [
        'how much house can i afford on 100k salary',
        'how much house can i afford on 100000 salary',
        'mortgage on 100k salary',
        '100k salary home affordability',
        'home buying on six figures',
    ],
    openGraph: {
        title: 'How Much House Can I Afford on a $100k Salary? | HomeRates.ai',
        description: 'See exactly how much home $100,000/year qualifies you for — three scenarios, live rates, monthly payment breakdown.',
        url: 'https://chat.homerates.ai/how-much-house-can-i-afford-on-100k-salary',
        siteName: 'HomeRates.ai',
        type: 'website',
    },
    alternates: { canonical: 'https://chat.homerates.ai/how-much-house-can-i-afford-on-100k-salary' },
};
    ...
    mainEntity: [
        {
            ...
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'On a $100,000 salary with no existing debts, you can typically afford up to $447,000 with FHA (3.5% down) or $560,000 with conventional 20% down at 2026 rates (~6.75%). With $500/month in debts, your range drops to $384,000–$482,000. These figures apply Fannie Mae\'s 43% back-end DTI guideline.',
            },
        },
        {
            '@type': 'Question',
            name: 'What is the monthly mortgage payment on a $100k salary?',
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'At 43% DTI on a $100,000 salary, your maximum monthly housing payment is approximately $3,583. On a $447,000 FHA purchase with 3.5% down at 6.75%, the monthly PITI is about $3,585. A comfortable 28–31% housing ratio on $100k is $2,333–$2,583/month.',
            },
        },
        {
            '@type': 'Question',
            name: 'Can I afford a $500,000 house on a $100k salary?',
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'It depends on your down payment and debts. With no debts and 20% down ($100,000), a $500,000 home at 6.75% has a PITI of about $3,195/month — that\'s 38.3% of your $8,333 monthly gross income, within the 43% limit but above the conservative 28% guideline. With FHA or low down payment, the monthly payment on $500k exceeds the 43% DTI limit on $100k income. Enter your exact scenario in the calculator.',
            },
        },
        {
            '@type': 'Question',
            name: 'How much do I need saved to buy a house on a $100k salary?',
            acceptedAnswer: {
                '@type': 'Answer',
                text: 'For FHA on a $447,000 home: 3.5% down ($15,645) + 3% closing costs (~$13,410) = about $29,055 minimum. For conventional 3% on $453,000: ~$24,900. For conventional 20% on $560,000: ~$126,000. Savings of $35,000 covers FHA comfortably.',
            },
        },
    ],
};
...
const schemaBreadcrumb = {
    ...
    itemListElement: [
        ...
        { '@type': 'ListItem', position: 3, name: 'How Much House on $100k Salary', item: 'https://chat.homerates.ai/how-much-house-can-i-afford-on-100k-salary' },
    ],
};

const scenarios = [
    { debt: '$0/mo', fha: '$447k', fhaPmt: '$3,585', conv3: '$453k', conv3Pmt: '$3,580', conv20: '$560k', conv20Pmt: '$3,582' },
    { debt: '$300/mo', fha: '$409k', fhaPmt: '$3,280', conv3: '$415k', conv3Pmt: '$3,280', conv20: '$513k', conv20Pmt: '$3,282' },
    { debt: '$500/mo', fha: '$384k', fhaPmt: '$3,079', conv3: '$390k', conv3Pmt: '$3,083', conv20: '$482k', conv20Pmt: '$3,083' },
];

const faqs = [
    {
        q: 'How much house can I afford on a $100,000 salary?',
        a: 'With no debts: $447,000 FHA (3.5% down) or $560,000 conventional 20% down at 2026 rates. With $500/month debts: $384,000–$482,000. Uses Fannie Mae 43% back-end DTI. Enter your exact numbers for a precise figure.',
    },
    {
        q: 'Can I afford a $500,000 house on a $100k salary?',
        a: 'With 20% down and no debts, yes — PITI on $500k at 6.75% is ~$3,195/month, which is 38.3% of gross income. With FHA or 3% down, the payment exceeds the 43% DTI limit on $100k. The higher your down payment, the more accessible a $500k home becomes.',
    },
    {
        q: 'What monthly payment is comfortable on $100k?',
        a: 'The conservative 28% front-end guideline puts your comfortable housing at $2,333/month. The 31% FHA guideline is $2,583/month. The 43% DTI maximum is $3,583/month. Most financial advisors suggest staying closer to 28–31% to leave room for savings, retirement, and emergencies.',
    },
    {
        q: 'How much do I need saved on a $100k salary?',
        a: 'FHA on $447k: ~$29,000 total. Conventional 3% on $453k: ~$24,900. Conventional 20% on $560k: ~$126,000. Savings of $35,000 covers FHA with a buffer for reserves, which most lenders want to see post-closing.',
    },
];

export default function Income100kPage() {
    return (
        <>
            ...
            <main className="income-page">
                <nav className="breadcrumb" aria-label="Breadcrumb">
                    <ol>
                        ...
                        <li aria-hidden="true">›</li>
                        <li aria-current="page">$100k Salary</li>
                    </ol>
                </nav>
                <section className="hero">
                    <h1>How Much House Can I Afford on a $100k Salary?</h1>
                    <p className="hero-lead">On a $100,000 annual income, you can typically qualify for a home between <strong>$384,000 and $560,000</strong> depending on your down payment, debts, and loan type. Here are the real numbers at 2026 rates.</p>
                ...
                <section className="calculator-embed" id="calculator">
                    ...
                    <div className="seed-chips">
                        ...
                        <a href="/?sq=I+make+%24100k+and+have+%2435k+saved%2C+no+debts" className="seed-chip">$35k saved, no debts</a>
                        <a href="/?sq=I+make+%24100k+and+have+%2435k+saved+with+a+%24300+car+payment" className="seed-chip">$35k saved, $300/mo car</a>
                        <a href="/?sq=I+make+%24100k+and+have+%2460k+saved%2C+no+debts" className="seed-chip">$60k saved, no debts</a>
                    </div>
                    <div className="cta-block">
                        <a href="/?sq=I+make+%24100%2C000+a+year+and+have+%2435%2C000+saved+%E2%80%94+how+much+house+can+I+afford%3F" className="cta-button">Calculate my affordability →</a>
                        <p className="cta-sub">Free · No login · Result in seconds</p>
                    </div>
                </section>
                <section className="example-table-section">
                    <h2>$100k salary — home affordability by debt load</h2>
