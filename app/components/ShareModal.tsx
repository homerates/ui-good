                ...
                {onSocialShare && (
                    <div style={{ marginBottom: 20 }}>
                        ...
                        <div style={{ display: 'flex', gap: 10 }}>
                            ...
                            {/* Instagram — web API not available, copies link */}
                            <button
                                ...
                                title="Copies link — paste into your Instagram Story or post"
                            >
                                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#e1306c" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <p style={{ margin: '8px 0 0', fontSize: 11, color: '#475569', lineHeight: 1.5 }}>
                            Instagram: copies the link — paste it into your Story or post caption.
                        </p>
                    </div>
                )}
