...
// IMPORTANT: all titleTemplates must include {date} so each day generates a
// unique slug. {month}-only titles repeat within the same month and get deduped.
export const MARKET_NEWS_TOPICS: TopicSeed[] = [
  ...
  },
  {
    category: 'market-news',
    tag: 'Fed Policy',
    titleTemplate: 'Fed Policy Update: What It Means for Mortgage Rates — {date}',
  ...
  },
  {
    category: 'market-news',
    tag: 'Housing Market',
    titleTemplate: 'Housing Inventory Report: Market Update — {date}',
  ...
  },
  {
    category: 'market-news',
    tag: 'Home Prices',
    titleTemplate: 'Home Prices Today — Where Are Values Headed? {date}',
  ...
  },
  {
    category: 'market-news',
    tag: 'Refinance',
    titleTemplate: 'Refinance Watch: Should You Lock In Before Rates Move? {date}',
  ...
  },
  {
    category: 'market-news',
    tag: 'Economy',
    titleTemplate: 'Inflation & Mortgage Rates — Market Analysis {date}',
  ...
  },
  {
    category: 'market-news',
    tag: 'Mortgage Rates',
    titleTemplate: '30-Year vs 15-Year Fixed Rate Spread — {date}',
  ...
  },
  {
    category: 'market-news',
    tag: 'Home Prices',
    titleTemplate: 'Fastest-Rising Home Values: City Rankings as of {date}',
  ...
  },
  {
    category: 'market-news',
    tag: 'Housing Market',
    titleTemplate: 'Buyer vs. Seller Market: Who Has the Upper Hand? {date}',
  ...
  },
  {
    category: 'market-news',
    tag: 'Economy',
    titleTemplate: 'Jobs Report & Mortgage Rates: Housing Market Impact — {date}',
  ...
  },
  {
    category: 'market-news',
    tag: 'Mortgage Rates',
    titleTemplate: 'Rate Lock Alert — Lock or Float Today? {date}',
  ...
  },
  {
    category: 'market-news',
    tag: 'Housing Market',
    titleTemplate: 'New Construction vs Existing Homes: Supply Gap Update — {date}',
  ...
  },
  {
    category: 'market-news',
    tag: 'Mortgage Rates',
    titleTemplate: 'Weekly Mortgage Rate Forecast: What to Expect — {date}',
    searchQuery: 'mortgage rate forecast next week direction prediction 2026 expert outlook',
    seoFocus: 'mortgage rate forecast 2026',
  },
  {
    category: 'market-news',
    tag: 'Economy',
    titleTemplate: 'Treasury Yield & Mortgage Rate Spread: Latest Reading — {date}',
    searchQuery: '10 year treasury yield mortgage rate spread basis points 2026',
    seoFocus: '10 year treasury mortgage rate spread',
  },
  {
    category: 'market-news',
    tag: 'Housing Market',
    titleTemplate: 'Pending Home Sales & Demand Signals — {date}',
    searchQuery: 'pending home sales existing home sales NAR housing demand 2026',
    seoFocus: 'pending home sales 2026',
  },
  {
    category: 'market-news',
    tag: 'Home Prices',
    titleTemplate: 'Affordability Index Update: Can Buyers Afford Today\'s Prices? {date}',
    searchQuery: 'housing affordability index median income home price ratio 2026',
    seoFocus: 'housing affordability 2026',
  },
  {
    category: 'market-news',
    tag: 'Refinance',
    titleTemplate: 'Cash-Out Refinance Activity: Homeowner Equity Trends — {date}',
    searchQuery: 'cash out refinance home equity tappable equity trends 2026',
    seoFocus: 'cash out refinance trends 2026',
  },
  {
    category: 'market-news',
    tag: 'Economy',
    titleTemplate: 'Fed Meeting Preview: Rate Decision Impact on Mortgages — {date}',
    searchQuery: 'FOMC meeting Federal Reserve rate decision mortgage rates 2026',
    seoFocus: 'Fed rate decision mortgage rates',
  },
  {
    category: 'market-news',
    tag: 'Housing Market',
    titleTemplate: 'Days on Market Trending Down or Up? Buyer Competition — {date}',
    searchQuery: 'days on market housing competition offer acceptance rate 2026 Redfin Zillow',
    seoFocus: 'housing market competition 2026',
  },
  {
    category: 'market-news',
    tag: 'Mortgage Rates',
    titleTemplate: 'ARM vs Fixed Rate: Which Makes Sense Right Now? {date}',
    searchQuery: 'adjustable rate mortgage ARM vs fixed rate comparison current market 2026',
    seoFocus: 'ARM vs fixed rate today 2026',
  },
];
