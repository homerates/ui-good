...
// ─────────────────────────────────────────────────────────────────────────────
// BUYDOWN ANALYZER CARD
// Computes year-by-year 2/1, 1/0, or 3/2/1 buydown schedule, cost, and
// side-by-side permanent buydown comparison with breakeven.
// ─────────────────────────────────────────────────────────────────────────────
export function buildBuydownCard(
    ...
    const { purchasePrice, loanAmount, annualRatePct, buydownType, isVA, sellerCredit, annualTax, annualInsurance } = params;
    ...
    // Permanent buydown comparison (same dollars)
...
// ─────────────────────────────────────────────────────────────────────────────
// SELLER CREDIT ALLOCATOR CARD
// Shows all four allocation strategies for a seller credit side-by-side:
// 2/1 buydown, max permanent points, closing costs only, 1pt + costs split.
// ─────────────────────────────────────────────────────────────────────────────
export function buildSellerCreditCard(
    ...
    // Path D: 1 permanent point + rest for costs
