...
// ─── Agent pilot invite ───────────────────────────────────────────────────────
// Sent to principal broker / office manager with a pilot link for their agents.

export async function emailAgentPilotInvite({
  toEmail,
  contactName,
  companyName,
  pilotUrl,
  ...
  try {
    await resend.emails.send({
      ...
      html: emailShell(`
        ...
        <p style="margin:0 0 24px;font-size:15px;color:#8b949e;line-height:1.7;">
          The idea is simple: your agents get instant AI-powered property intelligence — live market data, buyer decision scoring, comparable analysis, and financing scenarios — without replacing any tools they already use. We want real feedback from agents in the field, not top-down.
        </p>

        <!-- Pilot terms -->
        <table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 28px;background:#1c2433;border:1px solid rgba(255,255,255,0.07);border-radius:14px;overflow:hidden;">
          <tr><td style="padding:14px 20px;border-bottom:1px solid rgba(255,255,255,0.06);">
            <p style="margin:0 0 3px;font-size:11px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#9ca3af;">What each agent gets</p>
            <p style="margin:0;font-size:17px;font-weight:700;color:#00e87a;">${creditsPerAgent.toLocaleString()} credits + Founding Member status</p>
            <p style="margin:4px 0 0;font-size:13px;color:#8b949e;">Full platform access from day one. No trial mode, no feature gates.</p>
          </td></tr>
          <tr><td style="padding:14px 20px;border-bottom:1px solid rgba(255,255,255,0.06);">
            <p style="margin:0 0 3px;font-size:11px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#9ca3af;">What it costs</p>
          ...
          <tr><td style="padding:14px 20px;">
            <p style="margin:0 0 3px;font-size:11px;font-weight:700;letter-spacing:.06em;text-transform:uppercase;color:#9ca3af;">How to activate</p>
            <p style="margin:0;font-size:14px;color:#e6edf3;line-height:1.6;">Share the link below with your agents — they sign in and get instant founding access. No forms, no waitlist, no approval needed.</p>
          </td></tr>
        </table>
        ...
        <a href="${pilotUrl}"
           style="display:block;text-align:center;background:#00e87a;color:#07100f;font-size:15px;font-weight:800;padding:16px 20px;border-radius:999px;text-decoration:none;margin-bottom:16px;letter-spacing:0.01em;">
          ${companyName} agent pilot link →
        </a>
        <p style="margin:0 0 24px;text-align:center;font-size:13px;color:#8b949e;">
          Forward this link to your agents or copy it from below:<br>
          <span style="color:#00e87a;font-weight:600;word-break:break-all;">${pilotUrl}</span>
        </p>
